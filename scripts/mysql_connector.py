...
def crear_base_datos(conn):
    ...
    print(f"Base de datos '{conn.database}' lista.")
    cursor.close()
...
if __name__ == "__main__":
    # Importar data
    db1 = pd.read_csv('/Users/lu/Documents/202402/Data_Mining/tareas/pset1/data/aisles.csv', sep=';')
    db2 = pd.read_csv("/Users/lu/Documents/202402/Data_Mining/tareas/pset1/data/departments.csv", sep=';')
    db3 = pd.read_csv("/Users/lu/Documents/202402/Data_Mining/tareas/pset1/data/instacart_orders.csv", sep=';')
    db4 = pd.read_csv("/Users/lu/Documents/202402/Data_Mining/tareas/pset1/data/order_products.csv", sep=';')
    db5 = pd.read_csv("/Users/lu/Documents/202402/Data_Mining/tareas/pset1/data/products.csv", sep=';')
    ...
    try:
        if conexion:
            ...
            conexion.database = db_config["database"]
